...
logP_values = np.loadtxt(f'{file_path}//logP_values.txt')
SA_scores = np.loadtxt(f'{file_path}//SA_scores.txt')
cycle_scores = np.loadtxt(f'{file_path}//cycle_scores.txt')
...
if __name__ == "__main__":
    ...
    score = absorbance_target(
        mol, [n_confs, xtb_path, target, sigma, threshold])
    print(score)
